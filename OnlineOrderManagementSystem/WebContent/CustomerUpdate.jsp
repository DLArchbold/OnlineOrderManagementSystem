	...
	<form action="CustomerServlet" method="post">
		<table>
			...
			<tr>
				<td>Customer name</td>
				<td>
					<%out.println("<input type=\"text\" name=\"customername\" value=" + "\""+ customer.getCustomername()+ "\"" + " maxlength=\"34\">");
			...
			<tr>
				<td>First name</td>
				<td>
					<%out.println("<input type=\"text\" name=\"contactfirstname\" value=" + "\""+ customer.getContactfirstname()+ "\"" + " maxlength=\"15\">");
			...
			<tr>
				<td>Last name</td>
				<td>
					<%out.println("<input type=\"text\" name=\"contactlastname\" value=" + "\""+ customer.getContactlastname()+ "\"" + " maxlength=\"11\">");
			...
			<tr>
				<td>Phone</td>
				<td>
					<%out.println("<input type=\"text\" name=\"phone\" value=" + "\""+ customer.getPhone()+ "\"" + " maxlength=\"18\">");
			...
			<tr>
				...
				<td>
					<%out.println("<input type=\"text\" name=\"addressline1\" value=" + "\""+ customer.getAddressline1()+ "\"" + " maxlength=\"32\">");
			...
			<tr>
				...
				<td>
					<%out.println("<input type=\"text\" name=\"addressline2\" value=" + "\""+ customer.getAddressline2()+ "\"" + " maxlength=\"24\">");
			...
			<tr>
				<td>City</td>
				<td>
					<%out.println("<input type=\"text\" name=\"city\" value=" + "\""+ customer.getCity()+ "\"" + " maxlength=\"17\">");
			...
			<tr>
				<td>State</td>
				<td>
					<%out.println("<input type=\"text\" name=\"state\" value=" + "\""+ customer.getState()+ "\"" + " maxlength=\"13\">");
			...
			<tr>
				<td>Postal code</td>
				<td>
					<%out.println("<input type=\"text\" name=\"postalcode\" value=" + "\""+ customer.getPostalcode()+ "\"" + " maxlength=\"9\">");
			...
			<tr>
				<td>Country</td>
				<td>
					<%out.println("<input type=\"text\" name=\"country\" value=" + "\""+ customer.getCountry()+ "\"" + " maxlength=\"12\">");
			...
			<tr>
				...
				<td>
					...
					out.println("<input type=\"text\" name=\"creditlimit\" value="+ "\"" + customer.getCreditlimit()+ "\">");
						out.println("nearest hundred thousand, 2 decimal places");
					%>
				</td>
			</tr>
