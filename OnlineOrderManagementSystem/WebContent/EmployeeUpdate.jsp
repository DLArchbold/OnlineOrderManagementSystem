	...
	<form action="EmployeesServlet" method="post">
		<table>
			...
			<tr>
				<td>Last name</td>
				<td>
					<%out.println("<input type=\"text\" name=\"lastname\" value=" + "\""+ employee.getLastname()+ "\"" + " maxlength=\"9\">");
			...
			<tr>
				<td>First name</td>
				<td>
					<%out.println("<input type=\"text\" name=\"firstname\" value=" + "\""+ employee.getFirstname()+ "\"" + " maxlength=\"8\">");
			...
			<tr>
				<td>Extension</td>
				<td>
					<%out.println("<input type=\"text\" name=\"extension\" value=" + "\""+ employee.getExtension()+ "\"" + " maxlength=\"5\">");
			...
			<tr>
				<td>E-mail</td>
				<td>
					<%out.println("<input type=\"text\" name=\"email\" value=" + "\""+ employee.getEmail()+ "\"" + " maxlength=\"31\">");
			...
			<tr>
				<td>Job title</td>
				<td>
					<%out.println("<input type=\"text\" name=\"jobtitle\" value=" + "\""+ employee.getJobtitle()+ "\"" + " maxlength=\"20\">");
