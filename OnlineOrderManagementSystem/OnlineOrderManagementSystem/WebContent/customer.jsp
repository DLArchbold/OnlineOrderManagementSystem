...
<body>
	<%
		...
		System.out.println(Customers.get(0).getEmployee().getFirstname());
	%>
	<div class="row col-md-6">
		<table class="table table-striped table-bordered table-sm">
			...
			<%
			System.out.println(Customers.get(0).getEmployee().getFirstname());
			System.out.println(Customers.get(1).getEmployee().getFirstname());
			for(int i = 0; i<Customers.size(); i++){
				...
				for (Customer t : Customers) {
					...
					if(!(t.getEmployee() == null)){
						...
						out.println("<td>" +"Employee does not exist" +  "</td>");
					}
